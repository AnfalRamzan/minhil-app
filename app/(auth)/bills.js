// app/(tabs)/billing.js - FIXED LAYOUT (Smaller Total Section)
...
export default function Billing() {
  ...
  const checkMarketPrice = async (product) => {
    ...
    const darazUrl = generateDarazLink(product.name);
    setMarketInfo({
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* Cart Items - Takes more space now */}
        <FlatList
          data={cart}
        ...
        {/* Total Section - SMALLER AND COMPACT */}
        <View style={styles.totalSection}>
          ...
          <TouchableOpacity style={styles.proceedBtn} onPress={generateBillAndLearn}>
            <Text style={styles.proceedBtnText}>Generate Bill & AI Learns →</Text>
          </TouchableOpacity>
        </View>
            ...
            <ScrollView style={styles.modalContent}>
              ...
              {marketInfo && (
                <View>
                  ...
                  <View style={styles.modalRow}><Text>Market Price:</Text><Text style={styles.modalMarketPrice}>{marketInfo.marketPrice ? formatPKR(marketInfo.marketPrice) : 'N/A'}</Text></View>
                  <TouchableOpacity style={styles.darazBtn} onPress={() => Linking.openURL(marketInfo.marketUrl)}>
                    <Text style={styles.darazBtnText}>🌐 View on Daraz</Text>
                  </TouchableOpacity>
                ...
                <View style={styles.confirmContainer}>
                  ...
                  <View style={styles.confirmButtons}>
                    ...
                    <TouchableOpacity style={styles.confirmOriginalBtn} onPress={() => setShowDiscountConfirmModal(false)}>
                      <Text style={styles.confirmOriginalText}>Use Original</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              )}
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalButtons}>
                <TouchableOpacity style={styles.saveModalBtn} onPress={addNewProduct}><Text style={styles.saveModalBtnText}>Add</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  toastContainer: { position: 'absolute', top: 10, left: 15, right: 15, backgroundColor: '#34a853', padding: 10, borderRadius: 10, zIndex: 1000, alignItems: 'center' },
